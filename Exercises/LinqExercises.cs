...
public sealed class LinqExercises
{
    ...
    public IEnumerable<string> Task04_FirstAnalyticsCourse()
    {
        ...
        if (course != null)
        {
            return [$"{course.Title} {course.StartDate}"];
        }
    ...
    {
        return [UniversityData.Enrollments.Any(e => !e.IsActive).ToString()];
    }
    ...
    {
        return [UniversityData.Lecturers.All(l => !string.IsNullOrEmpty(l.Department)).ToString()];
    }
